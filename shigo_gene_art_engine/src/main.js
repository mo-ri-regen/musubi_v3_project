  ...
  const layers = layersOrder.map((layerObj, index) => ({
    ...
    linkLayer:
      layerObj.options?.["linkLayer"] !== undefined
        ...
        : false,
    selectedId:
      layerObj.options?.["selectedId"] !== undefined
        ? layerObj.options?.["selectedId"]
        : false,
    metadataHidden:
      layerObj.options?.["metadataHidden"] !== undefined
        ? layerObj.options?.["metadataHidden"]
        : false,
    fileName:
      layerObj.options?.["fileName"] !== undefined
        ? layerObj.options?.["fileName"]
        : false,
    inTitle:
...
const addMetadata = (_dna, _edition) => {
  ...
  let tempMetadata = {
    name: `${namePrefix} ${titleMain}#${_edition}`,
...
const constructLayerToDna = (_dna = "", _layers = []) => {
  let mappedDnaToLayers = _layers.map((layer, index) => {
    ...
    return {
      ...
      linkLayer: layer.linkLayer,
      metadataHidden: layer.metadataHidden,
      fileName: layer.fileName,
      inTitle: layer.inTitle,
    ...
    while (
      ...
      if (isDnaUnique(dnaList, newDna)) {
        ...
        results.forEach((layer) => {
          ...
          //console.log(`linkLayer ${layer.linkLayer}`);
